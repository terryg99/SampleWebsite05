...
My interest picked up when I learned that AI-based code assistance was being added to Xcode 26. As a card-carrying (I paid my $99) Apple Developer, I downloaded beta releases of macOS 26 Tahoe and Xcode 26. Limited use of ChatGPT LLM is included with Xcode (it's hard to determine where exactly the limit is) and I also subscribed to Anthropic and invested the crazy sum of $5 to try out their APIs (Claude, Sonnet) as well. Xcode allows me to choose which LLM I wish to use.
